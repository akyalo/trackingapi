...
using Microsoft.EntityFrameworkCore;  // Since this is already in trackingapj.csproj it is not required here 
...
namespace trackingapi.Controllers
{
    ...
    public class IssueController : ControllerBase
    {
        ...
        ////  The  =>  above is same as  { return }   if you want to use brackets write it like below  
        //  public async Task<IEnumerable<Issue>> Get()
        ...
        [HttpDelete("{id , IssueType}")]

        [ProducesResponseType(typeof(Issue), StatusCodes.Status204NoContent)]
        [ProducesResponseType(typeof(Issue), StatusCodes.Status404NotFound)]

        public async Task<IActionResult> Delete(int id , string IssueType)
        {
